...
/**
 * Static preview of the Child Dashboard "overtime-new" Figma frame —
 * overdue active task + worm timer + 2 chore tiles (one done, one default).
 * Uses no live data so the layout can be inspected without a real schedule.
 */
const ChildOverduePreview = () => {
  ...
  // Overdue by 12 minutes → progress along the worm.
    ...
    <div className="min-h-screen flex flex-col items-center bg-cosmic">
      <div className="w-full max-w-[420px] px-sp-2 py-sp-5 flex flex-col gap-sp-2">
        ...
        <div className="flex flex-col items-center gap-sp-4 mb-sp-4">
          ...
          {/* Circular timer in overdue state */}
          <CircularTimer
...
export default ChildOverduePreview;
